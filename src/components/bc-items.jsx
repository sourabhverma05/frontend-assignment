...
const B2CItems = () => {
    return (
        <>
            <DropdownMenu>
                <DropdownMenuTrigger>
                    <p className={`relative sm:relative w-[110px] sm:w-[110px] bg-[#3552AA] text-white tracking-wide py-3 px-3 text-sm font-medium rounded-sm lg:w-[150px] lg:text-base xl:w-[130px] xl:text-sm 2xl:py-2 2xl:w-[130px]`}>B2C</p>
                </DropdownMenuTrigger>
                <DropdownMenuContent className={`flex flex-col`}>
                    ...
                    <Tooltip>
                        <TooltipTrigger>
                            <DropdownMenuItem>
                                <p className='w-[110px] sm:w-[110px] bg-[#3552AA] text-white tracking-wide py-3 px-3 text-sm font-medium rounded-sm lg:w-[130px] lg:text-base xl:w-[130px] xl:text-sm 2xl:py-2 2xl:w-[130px]'>Online</p>
                            </DropdownMenuItem>
                        </TooltipTrigger>
                        <TooltipContent>
                            <ProgressDetailsBox />
