...
const HomePage = () => {
    ...
    return (
        <div className='w-full 2xl:h-full 2xl:w-full 2xl:mx-auto 2xl:my-[5%]'>
            <TooltipProvider>
                <div className='flex flex-col sm:flex-col 2xl:flex-row'>
                    <img
                        src={GroupImage}
                        className='m-auto sm:m-auto rotate-90 sm:rotate-90 flex justify-center sm:justify-center items-center sm:items-center w-[10rem] h-[560px] sm:w-[10rem] sm:h-[560px] md:h-[660px] md:w-[11rem] lg:h-[930px] lg:w-[15rem] xl:w-[18rem] xl:h-[1100px] 2xl:h-[500px] 2xl:w-[10rem] 2xl:rotate-0 2xl:m-0 2xl:my-auto'
                        alt="#"
                    />
                    <div className="flex flex-row gap-[14px] sm:flex-row mt-[-215px] sm:mt-[-215px] sm:gap-[14px] md:gap-0 md:mt-[-260px] lg:gap-[45px] lg:mt-[-370px] xl:w-[300px]  xl:gap-[70px] xl:mt-[-440px] xl:ms-[63px] 2xl:my-auto 2xl:ms-0 2xl:flex-col 2xl:justify-center 2xl:gap-[38px] 2xl:text-lg">
                        ...
                        <div className={`flex sm:flex-col flex-col items-center w-[300px] md:w-[300px] 2xl:flex-row`}>
                            ...
                            <div className='flex items-center'>
                                <img src={ThreeArrow} className='sm:hidden w-[200px] h-[70px] 2xl:block 2xl:py-2 2xl:w-[300px] 2xl:h-20' alt="#" />
                    ...
                    <div className='flex flex-col gap-y-[20px] sm:flex-row sm:gap-[20px] sm:justify-center md:gap-[45px] lg:gap-[65px] xl:gap-[70px] xl:ms-[30px] 2xl:gap-6 2xl:ms-0 2xl:flex-col 2xl:justify-center 2xl:my-auto'>
                        <div className="sm:flex sm:flex-col sm:gap-3 2xl:gap-[12px]">
                            <div className='flex sm:flex items-center relative '>
                                <Button onClick={() => handleBtnsDetail("externalBtn")}
                                    className='bg-[#3552aa] hover:bg-[#4768cd] hover:text-white text-black focus:text-white w-[150px] tracking-wide py-3 px-3 text-sm font-medium rounded-sm sm:w-[110px] lg:w-[150px] lg:text-lg xl:w-[180px] xl:text-lg 2xl:py-2'>
                                    External
                                </Button>
                                {hide === "externalBtn" && <div className={`absolute sm:top-[30px] sm:left-[40px] top-[30px] left-[40px] xl:ms-[12px] 2xl:ms-[8.4rem] 2xl:mt-[-3.4rem] 2xl:flex`}>
                                    <div className='flex items-center'>
                                        <img src={ThreeArrow} className={`sm:hidden w-[150px] h-[65px] 2xl:block`} alt="#" />
                                        <img src={Arrow} className='sm:h-[100px] lg:ms-[25px] 2xl:hidden' alt="#" />
                                    </div>
                                    <div className='flex flex-col gap-y-2 w-[20%] sm:mt-[-10px] sm:ms-[-40px] mt-[-10px] ms-[-40px] xl:ms-[-52px] 2xl:ms-[0.1rem]'>
                                        <B2CItems />
                                        <B2CItems />
                                    </div>
                                </div>}
                            ...
                            <div className='flex items-center relative'>
                                ...
                                {hide === "internalBtn" && <div className={`absolute sm:top-[30px] sm:left-[40px] left-[145px] top-[-13px] xl:ms-[37px] 2xl:mt-[-3.4rem] 2xl:flex 2xl:ms-[8.4rem]`}>
                                    <div className='flex items-center'>
                                        <img src={ThreeArrow} className={`sm:hidden w-[150px] h-[65px] 2xl:block`} alt="#" />
                                        <img src={Arrow} className='sm:h-[100px] 2xl:hidden' alt="#" />
                                    </div>
                                    <div className='flex flex-col gap-y-2 w-[20%] sm:mt-[-10px] sm:ms-[-40px] mt-[-10px] ms-[-40px] xl:ms-[-78px] 2xl:ms-[0.1rem]'>
                                        <B2CItems />
                                        <B2CItems />
                                    </div>
                                </div>}
                        ...
                        <div className="sm:flex sm:flex-col sm:gap-3 2xl:gap-[12px]">
                            <div className="relative">
                                <div className='flex items-center'>
                                    ...
                                    {hide === "PRDBtn" && <div className={`absolute sm:top-[35px] sm:left-[50px]  top-[30px] left-[40px] xl:ms-[27px] 2xl:mt-[-3.4rem] 2xl:flex 2xl:ms-[7.8rem]`}>
                                        ...
                                        <div className='flex flex-col gap-y-2 w-[20%] sm:mt-[-10px] sm:ms-[-50px] mt-[-10px] ms-[-40px] xl:ms-[-77px] 2xl:ms-[0.1rem]'>
                                            <B2CItems />
                                            <B2CItems />
                                        </div>
                                    </div>}
                            ...
                            <div className='flex items-center relative'>
                                ...
                                {hide === "specsBtn" && <div className={`absolute sm:top-[35px] sm:left-[50px]  top-[30px] left-[40px] xl:ms-[27px] 2xl:mt-[-3.6rem] 2xl:flex 2xl:ms-[7.8rem]`}>
                                    ...
                                    <div className='flex flex-col gap-y-2 w-[20%] sm:mt-[-10px] sm:ms-[-50px] mt-[-10px] ms-[-40px] xl:ms-[-78px] 2xl:ms-[0.1rem]'>
                                        <B2CItems />
                                        <B2CItems />
                                    </div>
                                </div>}
