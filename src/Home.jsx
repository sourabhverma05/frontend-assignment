                ...
                <div className='flex flex-col sm:flex-col 2xl:flex-row'>
                    ...
                    <div className="flex flex-row gap-[5px] justify-center items-center mx-[285px] mt-[-190px] sm:flex-row sm:mt-[-215px] sm:gap-[20px] md:gap-11 md:mt-[-260px] lg:gap-[65px] lg:mt-[-370px] xl:gap-[60px] xl:mt-[-320px] xl:ms-[325px] 2xl:my-auto 2xl:ms-0 2xl:flex-col 2xl:justify-center 2xl:gap-[40px] 2xl:text-lg 2xl:mx-0">
                        ...
                        <div className={`flex sm:flex-col flex-col items-center w-[300px] md:w-[300px] 2xl:flex-row`}>
                            ...
                            <p className='py-3 px-1 sm:w-[110px] w-[110px] text-xs sm:text-xs bg-[#3552aa] hover:text-white tracking-wide text-center font-medium rounded-sm lg:w-[150px] lg:text-base xl:w-[130px] xl:text-sm 2xl:py-3 2xl:w-[200px]'>Research</p>
                        ...
                        <div className='flex flex-col sm:flex-col items-center w-[300px] 2xl:flex-row'>
                            <p className='py-3 px-1 sm:w-[110px] w-[110px] sm:text-xs text-xs text-center bg-[#82B3E8] hover:text-white tracking-wide font-medium rounded-sm lg:w-[150px] lg:text-base xl:w-[130px] xl:text-sm 2xl:py-3 2xl:w-[200px]'>Planning</p>
                            <div className='flex items-center'>
                        ...
                        <div className='flex flex-col sm:flex-col items-center w-[300px] 2xl:flex-row'>
                            <p className='py-3 px-1 sm:w-[110px] sm:text-xs w-[110px] text-xs bg-[#E96343] hover:text-white tracking-wide font-medium text-center rounded-sm lg:w-[150px] lg:text-base  xl:w-[130px] xl:text-sm 2xl:py-3 2xl:w-[200px]'>Desiging</p>
                            <div className='flex items-center'>
                                <img src={ThreeArrow} className='hidden sm:hidden w-[200px] h-[70px] 2xl:block 2xl:py-2 2xl:w-[300px] 2xl:h-20' alt="#" />
                        ...
                        <div className='flex flex-col sm:flex-col items-center w-[300px] 2xl:flex-row'>
                            <p className='py-3 px-1 sm:w-[110px] sm:text-xs w-[110px] text-xs bg-[#E8919D] hover:text-white text-center tracking-wide font-medium rounded-sm lg:w-[150px] lg:text-base  xl:w-[130px] xl:text-sm 2xl:py-3 2xl:w-[200px]'>Manufacturing</p>
                            <div className='flex items-center'>
                                <img src={ThreeArrow} className='hidden sm:hidden w-[200px] h-[70px] 2xl:block 2xl:py-2 2xl:w-[300px] 2xl:h-20' alt="#" />
                                <img src={Arrow} className='sm:h-full 2xl:hidden' alt="#" />
                            </div>
                        ...
                        <div className='flex flex-col sm:flex-col items-center w-[300px] 2xl:flex-row   '>
                            <p className='py-3 px-1 sm:w-[110px] sm:text-xs w-[110px] text-xs bg-[#a684eb] hover:text-white tracking-wide font-medium text-center rounded-sm lg:w-[150px] lg:text-base  xl:w-[130px] xl:text-sm 2xl:py-3 2xl:w-[200px]'>Salse/Marketing</p>
                            <div className='flex items-center'>
                                <img src={ThreeArrow} className='hidden sm:hidden w-[200px] h-[70px] 2xl:block 2xl:py-2 2xl:w-[300px] 2xl:h-20' alt="#" />
                                <img src={Arrow} className='sm:h-full 2xl:hidden' alt="#" />
                            </div>
                    ...
                    <div className='flex flex-row gap-[5px] m-auto sm:flex-row sm:gap-[20px] sm:justify-center md:gap-[45px] lg:gap-[65px] xl:gap-[60px] xl:ms-[215px] 2xl:gap-7 2xl:ms-[0px] 2xl:flex-col 2xl:justify-center 2xl:my-auto'>
                        ...
                        <div className="flex flex-col gap-4 sm:flex sm:flex-col sm:gap-3 2xl:gap-[12px]">
                            <div className='flex sm:flex items-center relative '>
                                <Button onClick={() => handleBtnsDetail("externalBtn")}
                                    className='bg-[#3552aa] hover:bg-[#4768cd] hover:text-white text-black focus:text-white w-[110px] tracking-wide py-3 px-1 text-sm font-medium rounded-sm sm:w-[110px] lg:w-[150px] lg:text-base  xl:w-[130px] xl:text-sm 2xl:py-2'>
                                    External
                                </Button>
                            ...
                            <div className='flex items-center relative'>
                                <Button onClick={() => handleBtnsDetail("internalBtn")}
                                    className='text-black sm:w-[110px] focus:text-white bg-[#3552aa] hover:bg-[#4768cd] hover:text-white tracking-wide py-3 px-1 text-sm font-medium rounded-sm w-[110px] lg:w-[150px] lg:text-base  xl:w-[130px] xl:text-sm 2xl:py-2'
                                >
                                    Internal
                                </Button>
                            ...
                            <div className="relative">
                                <div className='flex items-center'>
                                    <Button onClick={() => handleBtnsDetail("PRDBtn")}
                                        className='text-black sm:w-[110px] focus:text-white bg-[#82B3E8] hover:bg-[#91c1f6] hover:text-white tracking-wide py-3 px-1 text-sm font-medium rounded-sm w-[110px] lg:w-[150px] lg:text-base  xl:w-[130px] xl:text-sm 2xl:py-2'>
                                        PRD
                                    </Button>
                        ...
                        <div className="flex flex-col gap-4 sm:flex sm:flex-col sm:gap-3 2xl:gap-[12px]">
                            <div className='flex items-center relative'>
                                <Button onClick={() => handleBtnsDetail("hardwareBtn")}
                                    className='text-black sm:w-[110px] focus:text-white bg-[#E96343] hover:bg-[#f3704f] hover:text-white tracking-wide py-3 px-1 text-sm font-medium rounded-sm w-[110px] lg:w-[150px] lg:text-base  xl:w-[130px] xl:text-sm 2xl:py-2'>
                                    Hardware
                                </Button>
                        ...
                        <div className="flex flex-col gap-4 sm:flex sm:flex-col sm:gap-3 2xl:gap-[12px]">
                            <div className='flex items-center relative'>
                                <Button onClick={() => handleBtnsDetail("materialBtn")}
                                    className='text-black sm:w-[110px] focus:text-white bg-[#E8919D] hover:bg-[#eb9aa4] hover:text-white tracking-wide py-3 px-1 text-sm font-medium rounded-sm w-[110px] lg:w-[150px] lg:text-base  xl:w-[130px] xl:text-sm 2xl:py-2'>
                                    Material
                                </Button>
                        ...
                        <div className="flex flex-col gap-4 sm:flex sm:flex-col sm:gap-3 2xl:gap-[12px]">
                            <div className='flex items-center relative'>
                                <Button onClick={() => handleBtnsDetail("onlineBtn")}
                                    className='text-black sm:w-[110px] focus:text-white bg-[#A684EB] hover:bg-[#ae8eed] hover:text-white tracking-wide py-3 px-1 text-sm font-medium rounded-sm w-[110px] lg:w-[150px] lg:text-base  xl:w-[130px] xl:text-sm 2xl:py-2'>
                                    Online
                                </Button>
