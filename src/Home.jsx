                ...
                <div className='flex'>
                    ...
                    <div className="flex flex-col gap-[49px] justify-center">
                        <div className={`flex items-center w-[300px]`}>
                            <p className='bg-[#3552aa] hover:text-white tracking-wide text-center py-3 px-3 text-sm font-medium rounded-sm w-[150px]'>Research</p>
                            <div className='flex items-center'>
                                <img src={ThreeArrow} className='w-[200px] h-[70px]' alt="#" />
                            </div>
                        </div>
